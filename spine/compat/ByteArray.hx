...
// Plain haxe implementation from OpenFL code, that works without OpenFL
// Source: https://github.com/openfl/openfl/blob/develop/openfl/utils/ByteArray.hx

import haxe.io.Bytes;
import haxe.io.BytesData;

@:access(haxe.io.Bytes)
@:access(spine.compat.ByteArrayData)
